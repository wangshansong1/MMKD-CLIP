...
This repository contains the inference code for MMKD-CLIP, a visual language model distilled from 9 well-known biomedical CLIPs.
...
conda create -y -n mmkdclip python=3.11
# Activate the environment
conda activate mmkdclip

# Clone repository
git clone https://github.com/wangshansong1/MMKD-CLIP.git
cd MMKD-CLIP
